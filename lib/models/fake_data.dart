...
import 'package:project111/models/fake_data_tags.dart';

Map homeFakeData = {
  "image": Assets.images.screenPic.path,
  "writer": "آروین ویسی",
  "date": "دیروز",
  "views": "225",
  "shortDescription": """
...
List<TagsModel> tageList = [
  TagsModel(title: 'جاوا'),
  TagsModel(title: 'دارت'),
  TagsModel(title: 'کاتلین'),
  TagsModel(title: 'پایتون'),
  TagsModel(title: 'جی اس'),
  TagsModel(title: 'AI'),
  TagsModel(title: 'PHP'),
  TagsModel(title: 'C'),
];

List<TagsModel> selectTags = [];
