          ...
          () => Column(children: [
            Stack(
              children: [
                CachedNetworkImage(
                  imageUrl:
                      articleDetailController.articleDetailModel.value.image!,
            ...
            Padding(
              padding: const EdgeInsets.only(right: 10, top: 15, left: 15),
              child: Text(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Image(image: AssetImage(Assets.icons.avatar.path), width: 55),
                  const SizedBox(
                    width: 10,
                  ),
                  Text(
                    articleDetailController.articleDetailModel.value.author!,
                    style: textTheme.displaySmall,
                  ),
                  const SizedBox(
                    width: 10,
                  ...
                  Text(
                    articleDetailController.articleDetailModel.value.createdAt!,
            ...
            Padding(
              padding: const EdgeInsets.only(right: 40, left: 40, top: 25),
              child: Text(
