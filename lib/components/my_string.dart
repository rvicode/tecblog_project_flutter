class MyString {
  ...
  static const String shareText = """ یه سر به تک بلاگ بزن ;)  
  www.techblog.com """;
  static const String successfulLogin = """تبریک میگم ، ایمیل با موفقیت تایید شد
لطفا اطلاعات ثبت نام رو کامل کن""";
  static const String welcomText = """به تک‌بلاگ خوش اومدی
